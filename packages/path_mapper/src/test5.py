...
img_general = get_map_image(targets['bucheon'], type="2d")
img_road = get_map_image(targets['bucheon'], type="usedistrict")
...
mask_road_erase = cv2.bitwise_not(cv2.dilate(mask_road_erase, get_kernel(13)))
